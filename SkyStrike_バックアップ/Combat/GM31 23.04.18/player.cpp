...
//
//SpecialWeaponType Player::m_SpecialWeapon = WEAPON_LONG_MISSILE;
//
//void Player::Init()
//{
//	m_DepthEnable = true;
...
//			if (Input::GetKeyPress('A'))
//			{
//				if (m_ControllAngle < ROLL_SPEED)
//					m_ControllAngle += 0.005f;
//			}
//			else if (Input::GetKeyPress('D'))
//			{
//				if(m_ControllAngle > -ROLL_SPEED)
...
//			{
//				m_ControllAngle = -ROLL_SPEED * InputX::GetThumbLeftX(0);
//			}
//			else
//			{
//				m_ControllAngle = 0;
